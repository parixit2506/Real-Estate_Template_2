          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="flex items-center gap-2">
                <img src="/profile/profile-image.webp" alt="" className="w-5 h-5 rounded-full" />
                Profile
              </span>
            </Link>
                ...
                >
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      >
                        <span className="flex items-center gap-2">
                          <img src="/profile/profile-image.webp" alt="" className="w-6 h-6 rounded-full border border-white/20" />
                          View Profile
                        </span>
                      </Link>
                      <Link
