                            ...
                            {showInquiryModal && selectedInquiry && (
                                <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 sm:p-6 sticky-overlay">
                                    ...
                                    >
                                        <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                                            <div>
                                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Inquiry Details</h2>
                                        ...
                                        <div className="p-8 space-y-8 max-h-[60vh] overflow-y-auto custom-scrollbar">
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">{selectedInquiry.clientName}</h3>
